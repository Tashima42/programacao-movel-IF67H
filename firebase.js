...
import { getFirestore, getDoc, setDoc, addDoc, doc, Timestamp, collection, query, where, getDocs } from "firebase/firestore";
import { getStorage, ref, uploadString } from "firebase/storage";

const firebaseConfig = {
  apiKey: "AIzaSyBiYiaxt8q1aDmED0e5JQmLOv76iqLNdFQ",
  authDomain: "projeto-mobile-7af32.firebaseapp.com",
...
export const vaccine = {
  ...
  getById: async (id) => {
    try {
      ...
      vaccine.dose = vaccine.date.toDate()
